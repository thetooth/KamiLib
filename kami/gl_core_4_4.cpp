...
namespace gl
{
	namespace exts
	{
		...
		LoadTest var_NV_texture_barrier;
		LoadTest var_NV_copy_image;
		
	} //namespace exts
	
	namespace _detail
	{
		typedef void (CODEGEN_FUNCPTR *PFNTEXTUREBARRIERNV)();
		PFNTEXTUREBARRIERNV TextureBarrierNV = 0;
		
		static int Load_NV_texture_barrier()
		{
			int numFailed = 0;
			TextureBarrierNV = reinterpret_cast<PFNTEXTUREBARRIERNV>(IntGetProcAddress("glTextureBarrierNV"));
			if(!TextureBarrierNV) ++numFailed;
			return numFailed;
		}
		
		typedef void (CODEGEN_FUNCPTR *PFNCOPYIMAGESUBDATANV)(GLuint, GLenum, GLint, GLint, GLint, GLint, GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei);
		PFNCOPYIMAGESUBDATANV CopyImageSubDataNV = 0;
		
		static int Load_NV_copy_image()
		{
			int numFailed = 0;
			CopyImageSubDataNV = reinterpret_cast<PFNCOPYIMAGESUBDATANV>(IntGetProcAddress("glCopyImageSubDataNV"));
			if(!CopyImageSubDataNV) ++numFailed;
			return numFailed;
		}
	...
	namespace sys
	{
		namespace 
		{
			...
			void InitializeMappingTable(std::vector<MapEntry> &table)
			{
				...
				table.push_back(MapEntry("GL_NV_texture_barrier", &exts::var_NV_texture_barrier, _detail::Load_NV_texture_barrier));
				table.push_back(MapEntry("GL_NV_copy_image", &exts::var_NV_copy_image, _detail::Load_NV_copy_image));
			}
			...
			void ClearExtensionVars()
			{
				...
				exts::var_NV_texture_barrier = exts::LoadTest();
				exts::var_NV_copy_image = exts::LoadTest();
			}
