...
namespace gl
{
	namespace exts
	{
		...
		extern LoadTest var_NV_texture_barrier;
		extern LoadTest var_NV_copy_image;
	...
	namespace _detail
	{
		...
		extern void (CODEGEN_FUNCPTR *TextureBarrierNV)();
		
		extern void (CODEGEN_FUNCPTR *CopyImageSubDataNV)(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);
	...
	inline void TextureBarrierNV(){_detail::TextureBarrierNV();}
	
	inline void CopyImageSubDataNV(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth){_detail::CopyImageSubDataNV(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, width, height, depth);}
